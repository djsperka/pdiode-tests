...
d:\work\usrig\bin\remote.exe 127.0.0.1 7000 fixstim -a -b gray -d 813 -e 1010101010101010101010101010101010101010101010101010101010101010 -L 30,0,64,(127/127/127),(255/255/255)
